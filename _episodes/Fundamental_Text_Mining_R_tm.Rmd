...
## Load library and Opening an example
...
View the data in Corpus format:

```{r}
# Print the first 9 row
...
### DATA
For this comparison, our data set is a sample of 19 documents from the Gutenburg Collection. The Gutenberg collection can be accessed in R using the gutenbergr package.
